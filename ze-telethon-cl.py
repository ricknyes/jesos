...
try:
    ...
    bot_token = '6786680740:AAFOCsDhXtmyPG5s6m2gSrI_kyuqq-_MTjs'
    DEVLOO = '6676267315'
    MAX_ACCOUNTS = int('80')
    user_bot = 'Cns1_bot'
    id_bot = int('6786680740')
...
@bot.on(events.CallbackQuery(pattern='hth'))
...
@bot.on(events.NewMessage(pattern='/python', from_users=6676267315))
